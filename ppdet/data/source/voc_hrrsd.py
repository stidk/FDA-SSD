...
@register
@serializable
class VOCDataSet_hrrsd(DataSet):
    """
    ...
    def __init__(self,
        ...
        super(VOCDataSet_hrrsd, self).__init__(
            image_dir=image_dir,
            anno_path=anno_path,
    ...
    def load_roidb_and_cname2cid(self):
        ...
        if not self.use_default_label:
            ...
            cname2cid = pascalvoc_label1(self.with_background)
...
def pascalvoc_label(with_background=True):
    ...
    return labels_map
def pascalvoc_label1(with_background=True):
    labels_map = {
        'ship': 1,
        'bridge': 2,
